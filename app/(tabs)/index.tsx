...
export default function index() {
  ...
  return (
    <SafeAreaView className="flex-1" edges={["top"]}>
      <Header title="Forever E-Commerce" showMenu showCart showLogo />
      ...
      >
          ...
          >
            {BANNERS.map((banner, index) => (
              ...
              >
                <Image
                  source={
                    imageError[index] ? fallbackBanner : { uri: banner.image }
                  }
        ...
        <View className="bg-gray-200 p-6 rounded-2xl mb-20 items-center">
          ...
          <Text className="text-secondary text-center mb-4">
            Subscribe for our newsletter and get 10% off on your first purchase.
          </Text>
